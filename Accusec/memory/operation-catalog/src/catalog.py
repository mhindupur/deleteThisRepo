...
OPERATIONS: dict[str, Operation] = {
    ...
    "compute.instance.start": Operation(
        ...
        required_tools=["aws.ec2.describe_instances", "aws.ec2.start_instances"],
        expected_postconditions=["lifecycle_state in {running, pending}"],
    ),
    "storage.volume.read": Operation(
        ...
        required_slots=["instance_id"],
        required_context_types=["entity_configuration", "topology"],
        required_tools=["aws.ec2.describe_volumes"],
    ),
    "storage.volume.expand": Operation(
        ...
        idempotent=True,
        approval_default=True,
        required_slots=["volume_id", "size_gb"],
        required_context_types=["entity_configuration", "policy"],
        required_tools=["aws.ec2.describe_volumes", "aws.ec2.modify_volume"],
        expected_postconditions=["configuration.size >= requested size_gb"],
    ),
}
