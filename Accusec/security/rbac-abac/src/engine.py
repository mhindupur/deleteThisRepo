...
DEFAULT_RULES = (
    PolicyRule(
        ...
        operations=("compute.instance.list", "compute.instance.read", "resource.read"),
    ...
    PolicyRule(
        roles=("cloud-operator",),
        operations=("compute.instance.list", "compute.instance.read", "resource.read", "inventory.sync"),
        entity_types=("aws.ec2.instance", "*"),
        effect=PolicyEffect.ALLOW,
        kind=AuthzKind.CONTEXT_ACCESS,
    ),
    PolicyRule(
        roles=("cloud-operator",),
        operations=("compute.instance.stop",),
        entity_types=("aws.ec2.instance",),
